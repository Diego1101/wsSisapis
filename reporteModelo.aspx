<%@ Page Language="C#" MasterPageFile="~/mpPrincipal.Master" AutoEventWireup="true" CodeBehind="reporteModelo.aspx.cs" Inherits="wsSisapis.reporteModelo" %>
     ...
     <div id="page-wrapper">
				...
				<!-- Wrapper -->
					<section id="bannercontenido" >
						<div class="inner" >
                            <h2>Reporte de predición de ventas por modelo</h2> 
						</div>
					</section>
